sap.ui.define(
  ...
  (BaseController, JSONModel, History, formatter) => BaseController.extend(
    "iot.planner.assignuserstocategories.controller.Object",
    {
      formatter,
      ...
      _onBindingChange() {
        ...
        const sObjectId = oObject.title;
        const sObjectName = oObject.Categories;
