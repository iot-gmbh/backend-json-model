...
alter table "public"."iot_planner_workitems" add column "activity" character varying(5000);

alter table "public"."iot_planner_workitems" add column "location" character varying(5000);

alter table "public"."iot_planner_workitems" alter column "date" set data type timestamp with time zone using "date"::timestamp with time zone;
...
create or replace view "public"."timetrackingservice_myworkitems" as  SELECT workitems_0.createdat,
    ...
    workitems_0.activity,
    workitems_0.location,
    workitems_0.type,
    workitems_0.source,
