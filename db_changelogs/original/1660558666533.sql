drop function if exists "public"."get_categories"(p_root character varying, p_date_from timestamp with time zone, p_date_until timestamp with time zone);

drop function if exists "public"."get_cumulative_category_durations"(p_username character varying, p_date_from timestamp with time zone, p_date_until timestamp with time zone);
...
CREATE OR REPLACE FUNCTION public.get_cumulative_category_durations(p_username character varying, p_tenant character varying, p_date_from timestamp with time zone, p_date_until timestamp with time zone)
...
CREATE OR REPLACE FUNCTION public.get_cumulative_category_durations_with_path(p_username character varying, p_tenant character varying, p_date_from timestamp with time zone, p_date_until timestamp with time zone)
...
CREATE OR REPLACE FUNCTION public.get_durations(p_username character varying, p_tenant character varying, p_date_from timestamp with time zone, p_date_until timestamp with time zone)
