...
alter table "public"."iot_planner_workitems" alter column "completedwork" set data type numeric using "completedwork"::numeric;

alter table "public"."iot_planner_workitems" alter column "duration" drop default;

alter table "public"."iot_planner_workitems" alter column "duration" set data type numeric using "duration"::numeric;

alter table "public"."iot_planner_workitems" alter column "originalestimate" set data type numeric using "originalestimate"::numeric;

alter table "public"."iot_planner_workitems" alter column "remainingwork" set data type numeric using "remainingwork"::numeric;
