...
alter table "public"."iot_planner_categories" add column "catnumber" character varying(5000);

alter table "public"."iot_planner_categories" add column "levelspecificid" character varying(5000);

alter table "public"."iot_planner_categorylevels" add column "depth" integer;
   ...
   FROM ( WITH RECURSIVE childrencte AS (
                ...
                UNION
                 SELECT this.id,
                    ...
                    this.reference,
                    this.parent_id,
                    ((((prior.catnumber)::text || '-'::text) || (this.catnumber)::text))::character varying(5000) AS path,
