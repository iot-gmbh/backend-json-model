alter table "public"."iot_planner_tags" alter column "workitem_id" set data type character varying(5000) using "workitem_id"::character varying(5000);

alter table "public"."iot_planner_tags2workitems" alter column "workitem_id" set data type character varying(5000) using "workitem_id"::character varying(5000);

alter table "public"."iot_planner_workitems" alter column "id" set data type character varying(5000) using "id"::character varying(5000);
