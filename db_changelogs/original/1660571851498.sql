...
drop function if exists "public"."get_cumulative_category_durations_with_path"(p_tenant character varying, p_username character varying, p_date_from timestamp with time zone, p_date_until timestamp with time zone);
...
alter table "public"."iot_planner_categories" drop column "catnumber";

alter table "public"."iot_planner_categories" drop column "levelspecificid";

alter table "public"."iot_planner_categories" add column "deepreference" character varying(5000);

alter table "public"."iot_planner_categories" add column "shallowreference" character varying(5000);
