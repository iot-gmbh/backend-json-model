create table "public"."adminservice_categories_drafts" (
...
CREATE UNIQUE INDEX adminservice_categories_drafts_pkey ON public.adminservice_categories_drafts USING btree (id);

CREATE UNIQUE INDEX draft_draftadministrativedata_pkey ON public.draft_draftadministrativedata USING btree (draftuuid);

alter table "public"."adminservice_categories_drafts" add constraint "adminservice_categories_drafts_pkey" PRIMARY KEY using index "adminservice_categories_drafts_pkey";
...
create or replace view "public"."adminservice_draftadministrativedata" as  SELECT draftadministrativedata.draftuuid,
