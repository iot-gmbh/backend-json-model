drop view if exists "public"."catalogservice_authors";

drop view if exists "public"."catalogservice_books";

drop view if exists "public"."catalogservice_books_texts";

drop view if exists "public"."catalogservice_currencies";

drop view if exists "public"."catalogservice_currencies_texts";

drop view if exists "public"."catalogservice_tests";

drop view if exists "public"."catalogservice_tests_texts";

drop view if exists "public"."localized_catalogservice_authors";

drop view if exists "public"."localized_catalogservice_books";

drop view if exists "public"."localized_catalogservice_currencies";

drop view if exists "public"."localized_catalogservice_tests";

drop view if exists "public"."localized_de_catalogservice_authors";

drop view if exists "public"."localized_de_catalogservice_books";

drop view if exists "public"."localized_de_catalogservice_currencies";

drop view if exists "public"."localized_de_catalogservice_tests";

drop view if exists "public"."localized_de_sap_capire_bookshop_authors";

drop view if exists "public"."localized_de_sap_capire_bookshop_books";

drop view if exists "public"."localized_de_sap_capire_bookshop_genres";

drop view if exists "public"."localized_de_sap_common_currencies";

drop view if exists "public"."localized_fr_catalogservice_authors";

drop view if exists "public"."localized_fr_catalogservice_books";

drop view if exists "public"."localized_fr_catalogservice_currencies";

drop view if exists "public"."localized_fr_catalogservice_tests";

drop view if exists "public"."localized_fr_sap_capire_bookshop_authors";

drop view if exists "public"."localized_fr_sap_capire_bookshop_books";

drop view if exists "public"."localized_fr_sap_capire_bookshop_genres";

drop view if exists "public"."localized_fr_sap_common_currencies";

drop view if exists "public"."localized_sap_capire_bookshop_authors";

drop view if exists "public"."localized_sap_capire_bookshop_books";

drop view if exists "public"."localized_sap_capire_bookshop_genres";

drop view if exists "public"."localized_sap_common_currencies";

drop view if exists "public"."sap_capire_bookshop_view2";

drop view if exists "public"."sap_capire_bookshop_view1";

alter table "public"."sap_capire_bookshop_authors" drop constraint "sap_capire_bookshop_authors_pkey";

alter table "public"."sap_capire_bookshop_books" drop constraint "sap_capire_bookshop_books_pkey";

alter table "public"."sap_capire_bookshop_books_texts" drop constraint "sap_capire_bookshop_books_texts_pkey";

alter table "public"."sap_capire_bookshop_genres" drop constraint "sap_capire_bookshop_genres_pkey";

alter table "public"."sap_capire_bookshop_genres_texts" drop constraint "sap_capire_bookshop_genres_texts_pkey";

alter table "public"."sap_common_currencies" drop constraint "sap_common_currencies_pkey";

alter table "public"."sap_common_currencies_texts" drop constraint "sap_common_currencies_texts_pkey";

drop index if exists "public"."sap_capire_bookshop_authors_pkey";

drop index if exists "public"."sap_capire_bookshop_books_pkey";

drop index if exists "public"."sap_capire_bookshop_books_texts_pkey";

drop index if exists "public"."sap_capire_bookshop_genres_pkey";

drop index if exists "public"."sap_capire_bookshop_genres_texts_pkey";

drop index if exists "public"."sap_common_currencies_pkey";

drop index if exists "public"."sap_common_currencies_texts_pkey";

drop table "public"."sap_capire_bookshop_authors";

drop table "public"."sap_capire_bookshop_books";

drop table "public"."sap_capire_bookshop_books_texts";

drop table "public"."sap_capire_bookshop_genres";

drop table "public"."sap_capire_bookshop_genres_texts";

drop table "public"."sap_common_currencies";

drop table "public"."sap_common_currencies_texts";
...
create or replace view "public"."iot_planner_my_categories_with_tags" as  SELECT sub.id,
   ...
   FROM (iot_planner_my_categories sub
