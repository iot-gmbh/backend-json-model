...
create or replace view "public"."iot_planner_my_categories_with_tags" as  SELECT cat.id,
  ...
  GROUP BY cat.id, cat.title, cat.tenant, cat.parent_id, cat.description, cat.reference, cat.path, cat.deepreference, cat.shallowreference, cat.user_userprincipalname;
