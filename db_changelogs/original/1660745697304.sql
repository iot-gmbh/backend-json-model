drop function if exists "public"."get_my_categories"(p_tenant character varying, p_user character varying, p_root character varying, p_valid_at timestamp with time zone);

create table "public"."microsoft_graph_entity" (
    "id" text not null
);


create table "public"."microsoft_graph_outlookitem" (
    "id" text not null,
    "categories" text,
    "changekey" text,
...
CREATE UNIQUE INDEX microsoft_graph_entity_pkey ON public.microsoft_graph_entity USING btree (id);

CREATE UNIQUE INDEX microsoft_graph_outlookitem_pkey ON public.microsoft_graph_outlookitem USING btree (id);

alter table "public"."microsoft_graph_entity" add constraint "microsoft_graph_entity_pkey" PRIMARY KEY using index "microsoft_graph_entity_pkey";

alter table "public"."microsoft_graph_outlookitem" add constraint "microsoft_graph_outlookitem_pkey" PRIMARY KEY using index "microsoft_graph_outlookitem_pkey";
