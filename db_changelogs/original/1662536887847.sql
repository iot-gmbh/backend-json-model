...
alter table "public"."iot_planner_workitems" add column "activateddatetime" time without time zone;

alter table "public"."iot_planner_workitems" add column "completeddatetime" time without time zone;
