...
create table "public"."iot_planner_categories" (
    ...
    "manager_tenant" character varying(5000),
    "manager_userprincipalname" character varying(5000),
    "parent_id" character varying(36),
    "parent_tenant" character varying(5000)
);
...
create table "public"."iot_planner_tags" (
    ...
    "category_tenant" character varying(5000),
    "workitem_tenant" character varying(5000),
...
create table "public"."iot_planner_tags2categories" (
    "id" character varying(36) not null,
    "tenant" character varying(5000) not null,
    "tag_tenant" character varying(5000),
...
create table "public"."iot_planner_travels" (
    ...
    "modifiedby" character varying(255),
    "tenant" character varying(5000) not null,
    "user_tenant" character varying(5000),
...
create table "public"."iot_planner_workitems" (
    ...
    "assignedto_tenant" character varying(5000),
