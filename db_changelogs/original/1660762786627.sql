alter table "public"."microsoft_graph_entity" drop constraint "microsoft_graph_entity_pkey";

alter table "public"."microsoft_graph_outlookitem" drop constraint "microsoft_graph_outlookitem_pkey";

alter table "public"."msgraphservice_events" drop constraint "msgraphservice_events_pkey";

alter table "public"."msgraphservice_users" drop constraint "msgraphservice_users_pkey";

drop index if exists "public"."microsoft_graph_entity_pkey";

drop index if exists "public"."microsoft_graph_outlookitem_pkey";

drop index if exists "public"."msgraphservice_events_pkey";

drop index if exists "public"."msgraphservice_users_pkey";

drop table "public"."microsoft_graph_entity";

drop table "public"."microsoft_graph_outlookitem";

drop table "public"."msgraphservice_events";

drop table "public"."msgraphservice_users";
