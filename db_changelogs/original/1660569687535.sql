drop view if exists "public"."adminservice_draftadministrativedata";

alter table "public"."adminservice_categories_drafts" drop constraint "adminservice_categories_drafts_pkey";

alter table "public"."draft_draftadministrativedata" drop constraint "draft_draftadministrativedata_pkey";

drop index if exists "public"."adminservice_categories_drafts_pkey";

drop index if exists "public"."draft_draftadministrativedata_pkey";

drop table "public"."adminservice_categories_drafts";

drop table "public"."draft_draftadministrativedata";
...
begin RETURN QUERY WITH RECURSIVE cte AS (
    ...
    WHERE
        ...
        and validFrdeepReferencealid_at
deepReference
