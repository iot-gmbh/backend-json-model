...
create or replace view "public"."msgraphservice_datetimetimezone" as  SELECT datetimetimezone_0.id,
    datetimetimezone_0.datetime,
    datetimetimezone_0.timezone
   FROM microsoft_graph_datetimetimezone datetimetimezone_0;


create or replace view "public"."timetrackingservice_datetimetimezone" as  SELECT datetimetimezone_0.id,
    datetimetimezone_0.datetime,
    datetimetimezone_0.timezone
   FROM msgraphservice_datetimetimezone datetimetimezone_0;
