...
create or replace view "public"."iot_planner_categoriesaggr" as  SELECT categories_0.id,
    categories_0.tenant,
    categories_0.title,
    categories_0.description,
    categories_0.parent_id,
...
create or replace view "public"."iot_planner_categoriesaggr2" as  SELECT sub.id,
    sub.title,
    sub.tenant,
    sub.parent_id,
    sub.totalduration
