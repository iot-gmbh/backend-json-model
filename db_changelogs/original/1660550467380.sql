...
CREATE OR REPLACE FUNCTION public.get_categories(p_root character varying DEFAULT NULL::character varying, p_date_from timestamp with time zone DEFAULT now(), p_date_until timestamp with time zone DEFAULT now())
