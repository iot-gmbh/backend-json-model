...
alter table "public"."iot_planner_categories" add column "manager_tenant" character varying(5000);

alter table "public"."iot_planner_categories" add column "parent_tenant" character varying(5000);

alter table "public"."iot_planner_categories" alter column "tenant" set not null;

alter table "public"."iot_planner_categorylevels" alter column "tenant" set not null;

alter table "public"."iot_planner_tags" add column "category_tenant" character varying(5000);

alter table "public"."iot_planner_tags" add column "workitem_tenant" character varying(5000);

alter table "public"."iot_planner_tags" alter column "tenant" set not null;

alter table "public"."iot_planner_tags2categories" add column "category_tenant" character varying(5000);

alter table "public"."iot_planner_tags2categories" add column "tag_tenant" character varying(5000);

alter table "public"."iot_planner_tags2categories" alter column "tenant" set not null;

alter table "public"."iot_planner_tags2workitems" add column "tag_tenant" character varying(5000);

alter table "public"."iot_planner_tags2workitems" add column "workitem_tenant" character varying(5000);

alter table "public"."iot_planner_tags2workitems" alter column "tenant" set not null;

alter table "public"."iot_planner_travels" add column "parent_tenant" character varying(5000);

alter table "public"."iot_planner_travels" add column "user_tenant" character varying(5000);

alter table "public"."iot_planner_travels" alter column "tenant" set not null;

alter table "public"."iot_planner_users" add column "manager_tenant" character varying(5000);

alter table "public"."iot_planner_users" alter column "tenant" set not null;

alter table "public"."iot_planner_users2categories" add column "category_tenant" character varying(5000);

alter table "public"."iot_planner_users2categories" add column "user_tenant" character varying(5000);

alter table "public"."iot_planner_users2categories" alter column "tenant" set not null;

alter table "public"."iot_planner_workitems" add column "assignedto_tenant" character varying(5000);

alter table "public"."iot_planner_workitems" add column "parent_tenant" character varying(5000);

alter table "public"."iot_planner_workitems" alter column "tenant" set not null;

CREATE UNIQUE INDEX iot_planner_users_pkey ON public.iot_planner_users USING btree (tenant, userprincipalname);

CREATE UNIQUE INDEX iot_planner_categories_pkey ON public.iot_planner_categories USING btree (id, tenant);

CREATE UNIQUE INDEX iot_planner_categorylevels_pkey ON public.iot_planner_categorylevels USING btree (tenant, hierarchylevel);

CREATE UNIQUE INDEX iot_planner_tags2categories_pkey ON public.iot_planner_tags2categories USING btree (id, tenant);

CREATE UNIQUE INDEX iot_planner_tags2workitems_pkey ON public.iot_planner_tags2workitems USING btree (id, tenant);

CREATE UNIQUE INDEX iot_planner_tags_pkey ON public.iot_planner_tags USING btree (tenant, title);

CREATE UNIQUE INDEX iot_planner_travels_pkey ON public.iot_planner_travels USING btree (id, tenant);

CREATE UNIQUE INDEX iot_planner_users2categories_pkey ON public.iot_planner_users2categories USING btree (id, tenant);

CREATE UNIQUE INDEX iot_planner_users_friendlyid ON public.iot_planner_users USING btree (userprincipalname);

CREATE UNIQUE INDEX iot_planner_workitems_pkey ON public.iot_planner_workitems USING btree (tenant, id);

alter table "public"."iot_planner_users" add constraint "iot_planner_users_pkey" PRIMARY KEY using index "iot_planner_users_pkey";
...
alter table "public"."iot_planner_users" add constraint "iot_planner_users_friendlyid" UNIQUE using index "iot_planner_users_friendlyid";
...
create or replace view "public"."adminservice_tags" as  SELECT tags_0.tenant,
    tags_0.title,
    tags_0.category_id,
    tags_0.category_tenant,
    tags_0.workitem_tenant,
    tags_0.workitem_id
...
create or replace view "public"."adminservice_tags2categories" as  SELECT tags2categories_0.id,
    ...
    tags2categories_0.tag_tenant,
    tags2categories_0.tag_title,
    tags2categories_0.category_id,
    tags2categories_0.category_tenant
...
create or replace view "public"."adminservice_tags2workitems" as  SELECT tags2workitems_0.id,
    ...
    tags2workitems_0.tag_tenant,
    tags2workitems_0.tag_title,
    tags2workitems_0.workitem_tenant,
...
create or replace view "public"."adminservice_travels" as  SELECT travels_0.id,
    ...
    travels_0.tenant,
    travels_0.user_tenant,
    travels_0.user_userprincipalname,
    travels_0.parent_id,
    travels_0.parent_tenant
...
create or replace view "public"."adminservice_users2categories" as  SELECT users2categories_0.id,
    ...
    users2categories_0.user_tenant,
    users2categories_0.user_userprincipalname,
    users2categories_0.category_id,
    users2categories_0.category_tenant,
    user_1.displayname
   FROM (iot_planner_users2categories users2categories_0
     LEFT JOIN iot_planner_users user_1 ON ((((users2categories_0.user_tenant)::text = (user_1.tenant)::text) AND ((users2categories_0.user_userprincipalname)::text = (user_1.userprincipalname)::text))));
...
create or replace view "public"."iot_planner_hierarchies_hierarchies" as  SELECT categories_0.id,
   ...
   FROM (((iot_planner_categories categories_0
     LEFT JOIN iot_planner_categories parent_1 ON ((((categories_0.parent_id)::text = (parent_1.id)::text) AND ((categories_0.parent_tenant)::text = (parent_1.tenant)::text))))
     LEFT JOIN iot_planner_categories parent_2 ON ((((parent_1.parent_id)::text = (parent_2.id)::text) AND ((parent_1.parent_tenant)::text = (parent_2.tenant)::text))))
     LEFT JOIN iot_planner_categories parent_3 ON ((((parent_2.parent_id)::text = (parent_3.id)::text) AND ((parent_2.parent_tenant)::text = (parent_3.tenant)::text))));
...
create or replace view "public"."workitemsservice_iotworkitems" as  SELECT workitems_0.activateddate AS datum,
   ...
   FROM ((iot_planner_workitems workitems_0
     ...
     LEFT JOIN iot_planner_users assignedto_2 ON ((((workitems_0.assignedto_tenant)::text = (assignedto_2.tenant)::text) AND ((workitems_0.assignedto_userprincipalname)::text = (assignedto_2.userprincipalname)::text))))
...
create or replace view "public"."workitemsservice_workitems" as  SELECT workitems_0.createdat,
   ...
   FROM ((iot_planner_workitems workitems_0
     LEFT JOIN iot_planner_users assignedto_1 ON ((((workitems_0.assignedto_tenant)::text = (assignedto_1.tenant)::text) AND ((workitems_0.assignedto_userprincipalname)::text = (assignedto_1.userprincipalname)::text))))
