...
annotate my.Projects with @(UI : {
  ...
  Facets              : [
    ...
    {
      $Type  : 'UI.ReferenceFacet',
      Label  : '{i18n>Projects.subprojects}',
      Target : 'subprojects/@UI.LineItem'
    },
    {
      $Type  : 'UI.ReferenceFacet',
...
@cds.odata.valuelist
annotate my.Subprojects with @(UI : {
  PresentationVariant : {
    $Type          : 'UI.PresentationVariantType',
    SortOrder      : [{Property : title}],
    Visualizations : ['@UI.LineItem'],
  ...
  HeaderInfo          : {
    TypeName       : '{i18n>Subproject}',
    TypeNamePlural : '{i18n>Subprojects}',
    Title          : {Value : title},
    Description    : {Value : description},
  },
  Facets              : [{
